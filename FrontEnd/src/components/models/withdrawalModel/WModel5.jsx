    ...
    <div>
      ...
      >
        <p style={{ display: "flex", alignItems: "center", margin: "10px 0" }}>
          ...
          <span style={{ margin: "0 6px", width: "285px" }}>
            Withdraw Solana
          </span>
          <p
            style={{
      ...
      >
        <div>
          <div>
            ...
            >
              Please enter the Solana wallet address you wish to receive the
          ...
          <div>
            ...
            <div>
              ...
              <div style={{ margin: "0 25px" }}>
                ...
                >
                  *You will receive the specified Solana amount to your
                  withdrawal address
                </p>
